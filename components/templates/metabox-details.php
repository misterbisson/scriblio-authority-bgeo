...
<tr class="form-field">
	<th scope="row" valign="top">
		<label for="<?php echo $this->get_field_id( 'woeid' ); ?>">Bounds</label>
	</th>
	<td>
		<input type="text" id="<?php echo $this->get_field_id( 'woeid' ); ?>" name="<?php echo $this->get_field_name( 'woeid' ); ?>" value="<?php echo( esc_attr( $geo->woeid ) ); ?>" size="10" />
	</td>
</tr>
